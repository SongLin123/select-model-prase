(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.SelectModelPrase = factory());
    ...
    ***************************************************************************** */
     ...
     */
    function splitToken(el, addSymbol) {
        el = el.replace(/[\(|\)]/g, '');
        var splites = [];
        switch (true) {
    ...
    function splitExpr(rule, addSymbol) {
        var splites = [], tar = [];
        switch (true) {
        ...
        var tem = [tar[0], tar[1]].map(function (t) { return splitToken(t, addSymbol); });
    ...
    function filterRule (model) {
        ...
        for (var i = 0; i < rules.length; i++) {
            ...
            var tokens = splitExpr(rule);
            //   分开判断是否有一个token存在与约束规则里
            var result = tokens.map(function (tsi) {
                return tsi.some(function (t) {
                    return ves.some(function (ve) {
                        return ve.featureCode == t;
                    });
                });
            });
            // 左右都有至少一个存在与特征族中
            if (result.every(function (e) { return e === true; }))
                tar.push(rule);
        }
        return tar;
    }
     ...
     */
    // 装饰器
    function setable(target, propertyKey) {
        var key = Symbol(propertyKey);
        var DisableKey = Symbol(propertyKey + 'OptDisable');
        Object.defineProperty(target, propertyKey, {
            ...
            set: function (arg) {
                ...
                if (!arg)
                    return;
                this.effectRule
                    .map(function (r) { return splitExpr(r, true); })
                    .forEach(function (ruleItem) {
                    // 公式左边的
                    var left = ruleItem[0], right = ruleItem[1], concat = ruleItem[2], sym = left.pop(), meta = false;
                    var isMatch = function (token) {
                        return ['BAC', 'ITR', 'WWA', 'CRT', 'PKG'].some(function (it) {
                            if (it == 'PKG')
                                return arg.includes(token);
                            return token === _this[it];
                        });
                    };
                    switch (sym) {
                        case '&':
                            if (left.every(isMatch)) {
                                meta = true;
                            }
                            break;
                        case '|':
                            ...
                            right.forEach(function (r) {
                                if (r.startsWith('PKG') && !_this.PKG.includes(r)) {
                                    ...
                                    if (r.startsWith('BAC') && !_this.BACOptDisable.includes(r)) {
                                        _this.BACOptDisable.push(r);
                                    }
                                    if (r.startsWith('WW') && !_this.WWAOptDisable.includes(r)) {
                                        _this.WWAOptDisable.push(r);
                                    }
    ...
    var SelectModelPrase = /** @class */ (function () {
        function SelectModelPrase(json) {
            var _this = this;
            this.featrueG = new Map();
            this.models = [];
        ...
        SelectModelPrase.prototype.filterRelationShip = function (base, relationShipSym) {
        ...
        SelectModelPrase.prototype.getBasefeatrue = function (familyCode) {
            if (familyCode) {
                ...
                return __spread(this.featrueG.get(this.selectModel).values());
            }
        };
        // 获取相关特征组,过滤选配信息
        ...
        SelectModelPrase.prototype.getModels = function () {
            return lodash.cloneDeep(this.models);
        };
        SelectModelPrase.prototype.setModel = function (carTypeId) {
            var _this = this;
            if (this.selectModel)
                this.cleanDisable();
        ...
        __decorate([
            setable
        ], SelectModelPrase.prototype, "BAC", void 0);
        __decorate([
            setable
        ], SelectModelPrase.prototype, "ITR", void 0);
        __decorate([
            setable
        ], SelectModelPrase.prototype, "WWA", void 0);
        __decorate([
            setable
        ], SelectModelPrase.prototype, "CRT", void 0);
        __decorate([
            setable
        ], SelectModelPrase.prototype, "PKG", void 0);
        return SelectModelPrase;
    }());
